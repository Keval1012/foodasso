...
import CoverSizeReportFliter from "./CoverSizeReportFliter";
import CoverSizeReportTable from "./CoverSizeReportTable";

const CoverSizeReport = () => {
  ...
  return (
    <div className="p-4">
      ...
      {isExpanded && <CoverSizeReportFliter />}
      {/* Table */}
      {/* <OpenCloseTable /> */}
      <div className="border border-[#3D3D3D36]">
        <div className=" flex justify-between my-4">
          <h1 className="text-base text-[#3D3D3D] font-bold mb-4">
            Cover Size Report 01-08-2024
          </h1>
        ...
        <CoverSizeReportTable />
      </div>
    </div>
  );
};

export default CoverSizeReport;
