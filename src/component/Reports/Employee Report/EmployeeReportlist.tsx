...
import EmoloyeeFliter from "./EmoloyeeFliter";
...
const EmployeeReportlist = () => {
  ...
  return (
    <div className="p-4">
      ...
      {isExpanded && <EmoloyeeFliter />}
      {/* Table */}
      {/* <OpenCloseTable /> */}
      <div className="border border-[#3D3D3D36] p-3">
        <div className=" flex justify-between mt-4 border-b border-gray-300">
          <h1 className="text-base text-[#3D3D3D] font-bold mb-4 p-3">
            Employee Report-10-00-2024
          </h1>
          {/* Print and Export Buttons */}
          <div className="flex space-x-2 ml-4 p-3">
