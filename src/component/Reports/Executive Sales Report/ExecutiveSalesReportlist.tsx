...
import ExecutiveSalesReportTable from "./ExecutiveSalesReportTable";

const ExecutiveSalesReportlist = () => {
  ...
  return (
    <div className="p-4">
      <div className="flex justify-between items-center mb-6 border-b p-3 border-gray-300">
        <h2 className="text-xl font-semibold">Executive Sales Report</h2>
      ...
      {isExpanded && <ExecutiveSalesReportFliter />}
      {/* Table */}
      {/* <OpenCloseTable /> */}
      <div className=" flex justify-between ">
        <h1 className="text-base text-[#3D3D3D] font-bold mb-4">
          Executive Sales Report - 07-10-2024
        </h1>
        ...
        <div className="flex space-x-2 ml-4">
          ...
          <ExecutiveSalesReportTable />
    </div>
  );
};

export default ExecutiveSalesReportlist;
