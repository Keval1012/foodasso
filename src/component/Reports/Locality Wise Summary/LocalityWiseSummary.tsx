...
// import GroupFliter from "./GroupFliter";
import LocalityWiseSummaryFliter from "./LocalityWiseSummaryFliter";
import LocalityWiseSummaryTable from "./LocalityWiseSummaryTable";

const LocalityWiseSummary = () => {
  ...
  return (
    <div className="p-4">
      <div className="flex justify-between items-center mb-6 border-b p-3 border-gray-300">
        <h2 className="text-xl font-semibold">Group Report</h2>
      ...
      {isExpanded && <LocalityWiseSummaryFliter />}
      {/* Table */}
      {/* <OpenCloseTable /> */}
      ...
      <LocalityWiseSummaryTable />
    </div>
  );
};

export default LocalityWiseSummary;
