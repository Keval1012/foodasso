...
import VariationFliter from "./VariationFliter";
    ...
    return (
      <div className="p-4 ">
        <div className="flex justify-between items-center mb-6 border-b p-3 border-gray-300">
          <h2 className="text-xl font-semibold">Variation Report</h2>
        ...
        {/* Search bar */}
        <div className="flex justify-between items-center w-full  border-gray-300">
