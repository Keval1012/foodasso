...
const ExpenseDatelis = () => {
  
  const [rows, setRows] = useState<any>([{ id: 0, expense_name: "", amount: 0, explanation: "", employee: "", paid_from: "cash" }]);
  ...
  // console.log("expenseReasonList", expenseReasonList);
  // console.log("expenseEmployeeList", expenseEmployeeList);
    ...
    <div className="m-4 border">
              ...
              <tr key={r?.id} className="hover:bg-gray-50">
                ...
                <td className="px-4 py-2 border-b">
                  ...
                  <Select
                    ...
                    onChange={(selectedOption) => handleRowChange(r?.id, "expense_name", selectedOption?.value)}
                  />
                </td>
                {/* Amount input field */}
                <td className="px-4 py-2 border-b">
                ...
                <td className="px-4 py-2 border-b">
                  ...
                  <Select
                    ...
                    onChange={(selectedOption) => handleRowChange(r?.id, "employee", selectedOption?.value)}
                  />
                </td>
                {/* Paid From dropdown */}
                <td className="px-4 py-2 border-b">
                  ...
                  <Select
                    ...
                    // defaultValue={{ value: "cash", label: "From Cash" }}
                    defaultValue={paidFromList?.find(
                      (item) => item.value === r?.paid_from
                    ) || paidFromList[0]}
                    onChange={(selectedOption) => handleRowChange(r?.id, "paid_from", selectedOption?.value)}
                  />
                </td>
      ...
      <div className="flex justify-between bg-gray-100 py-4 px-2">
        ...
        <button
          // onClick={() => addRows(10)}
          onClick={addRows}
          className=" text-red-700 hover:text-red py-2 px-4 rounded-full border border-red-700"
        >
          + Add 10 Rows
        </button>
