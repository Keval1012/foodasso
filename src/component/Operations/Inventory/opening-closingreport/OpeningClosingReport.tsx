...
import OpenClosingFliter from "./OpenClosingFliter";
import OpenCloseTable from "./OpenCloseTable";
  ...
  return (
    <div className="p-4">
      <div className="flex justify-between items-center mb-6 border-b p-3 border-gray-300">
        <h2 className="text-xl font-semibold">Opening-Closing Report</h2>
