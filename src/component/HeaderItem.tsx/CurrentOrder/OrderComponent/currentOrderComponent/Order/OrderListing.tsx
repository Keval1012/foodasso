...
// const OrderListing: React.FC<Order> = ({ currentOrderAllOpeData }) => {
const OrderListing = () => {
  ...
  // const totalPages = Math.ceil(currentOrderAllOpeData.length / itemsPerPage);

  // const startIndex = (currentPage - 1) * itemsPerPage;
  // const endIndex = startIndex + itemsPerPage;
  // const paginatedData = currentOrderAllOpeData.slice(startIndex, endIndex);
  ...
  const handleOpenViewOrderDetails = (order: any) => {
  ...
  }, [currentPage, currentOrderFilterData]);
  ...
  console.log("currentOrderFilterData", currentOrderFilterData);
      ...
      <div className="">
        <div className="table-container overflow-x-auto max-h-96">
          <table className="min-w-full bg-white text-sm border border-gray-200">
            ...
            <tbody>
              {currentOrderAllOpeData?.data?.map((order: any) => (
                <tr
                  key={order?.id}
